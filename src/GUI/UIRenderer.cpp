...
void UIRenderer::renderUI(IGraphicsLib& graphics, IGuiLib& gui, CameraController& camera)
{
    m_frameCounter++;
...
void UIRenderer::renderStatusBar(IGuiLib& gui)
{
    gui.DrawStatusBar(0, DEFAULT_HEIGHT - 25, DEFAULT_WIDTH, 25, "Mode Test - Contrôle de caméra avec la souris");
}

void UIRenderer::renderCameraInfo(IGuiLib& gui, CameraController& camera)
{
...
void UIRenderer::renderFPS(IGraphicsLib& graphics)
{
